...
/**
   ...
   <P style="font-size: 125%;"><B>{@code {@.codelet com.github.aliteralmind.codelet.examples.TrivialAppWithCommandLineParams:eliminateCmtBlocksPkgLineAndPkgReferences(true, true, false)}}
   <BR>{@code {@.codelet.out com.github.aliteralmind.codelet.examples.TrivialAppWithCommandLineParams("string one", "string two")}}</B></P>

{@.codelet com.github.aliteralmind.codelet.examples.TrivialAppWithCommandLineParams:eliminateCmtBlocksPkgLineAndPkgReferences(true, true, false)}

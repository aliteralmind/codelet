...
/**
   ...
   <A NAME="gaps"/><H2><A HREF="{@docRoot}/com/github/aliteralmind.codelet/CodeletTemplateBase.html"><IMG SRC="{@docRoot}/resources/up_arrow.gif"/></A> &nbsp; Codelet: {@code {@.codelet.and.out}}: Template: <U>Gap names</U></H2>

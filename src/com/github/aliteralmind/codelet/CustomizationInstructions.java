...
/**
   ...
   <A NAME="3_parts"></a><h4><a href="#overview"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> Codelet: Customizer: <u>Three parts</u></h4>
   ...
   <A NAME="3_parts_filter"></a><h4><a href="#3_parts"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> Codelet: Customizer: Three parts: <u>Part 1: Line filter</u></h4>
   ...
   <A NAME="3_parts_alterer"></a><h4><a href="#3_parts"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> Codelet: Customizer: Three parts: <u>2: Alterer</u></h4>
   ...
   <A NAME="3_parts_template"></a><h4><a href="#3_parts"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> Codelet: Customizer: Three parts: <u>3: Template</u></h4>
   ...
   <A NAME="overview"></a><h2><a href="{@docRoot}/overview-summary.html#overview_description"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> &nbsp; Codelet: Customizer: <u>Overview</u></h2>
   ...
   <A NAME="func_does_nothing"></a><h2><a href="#overview"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> &nbsp; Codelet: Customizer function: <u>Example: A customizer that does nothing</u></h2>
...
{@.codelet com.github.aliteralmind.codelet.examples.DoNothingCustomizer%lineRangeWithReplace(1, true, "(<SourceCodeTemplate> aCustomizerThatDoesNothing)", "$1", "FIRST", 1, true, "&#125; +//End snippet$", "&#125;", "FIRST", "^   ")}
   ...
   <A NAME="specifications"></a><h2><a href="#overview"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> &nbsp; Codelet: Customizer: <u>Requirements</u></h2>
   ...
   <A NAME="xmpl_defaults"></a><h2><a href="#overview"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> &nbsp; Codelet: Customizer: Taglet syntax: Example: <u>Default function name and class location</u></h2>
...
<blockquote>{@code {@.codelet fully.qualified.examples.ExampleClassName:package.of.EnclosingClass#getSourceCode_ExampleClassName()}}</blockquote>
   ...
   <A NAME="proc_custom_post"></a><h2><a href="#overview"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> &nbsp; Codelet: Customizer: Taglet syntax: Example: <u>Defaults with custom postfix</u></h2>
...
<blockquote>{@code {@.codelet fully.qualified.examples.ExampleClassName%_ExtraStuff()}}</blockquote>
   ...
   <A NAME="xmpl_sig"></a><h2><a href="#overview"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> &nbsp; Codelet: Customizer: Taglet syntax: Example: <u>Specifying the class in which the processor function exists</u></h2>
...
<blockquote>{@code {@.codelet fully.qualified.examples.ExampleClassName:fully.qualified.package.MyCodeletCustomizers#(true, "See line 12")}}</blockquote>
   ...
   <A NAME="xmpl_params"></a><h2><a href="#overview"><img src="{@docRoot}/resources/up_arrow.gif" alt="Up arrow"></a> &nbsp; Codelet: Customizer: Taglet syntax: Example: <u>Specifying extra processor parameters</u></h2>

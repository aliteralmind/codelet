...
/**
   <P>Indicates an alteration was attempted in a customizer, but was not made (such as when the find-what text is not found in the source code).</P>

   @see  com.github.aliteralmind.codelet.CodeletBaseConfig#ALTERATION_NOT_MADE_CRASH

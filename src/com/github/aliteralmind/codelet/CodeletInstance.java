...
<blockquote>{@code [DEBUG_LEVEL_3]{@.codelet com.github.myjavacode.examples.AnExample}}</blockquote>
   ...
   /**
      <p>The character that divides the fully-qualified class-name or plain-text file-path, and its optional <a href="CustomizationInstructions.html#overview">Codelet-customizer</a>--Equal to {@code '%'}.</p>
